...
![run_debug_config](img/1_run_debug_config.png)<br />
...
![envrionment_vars](img/2_envrionment_vars.png)<br />
PYTHONBUFFERED: 값은 1로 기본적으로 설정되어있다. 나는 유지했다.<br />

3. Path mappings 디테일<br />
![path_mappings](img/3_path_maping.png)<br />

4. Docker Container settings 디테일<br />
![docker_contatiner_settings](img/4_docker_contatiner_settings.png)<br />
